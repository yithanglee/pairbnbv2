...
ActiveRecord::Schema.define(version: 20161024015007) do
  ...
  create_table "reservation_dates", force: :cascade do |t|
    ...
    t.datetime "created_at",     null: false
    t.datetime "updated_at",     null: false
    t.index ["reservation_id"], name: "index_reservation_dates_on_reservation_id", using: :btree
    t.index ["staying_dates"], name: "index_reservation_dates_on_staying_dates", using: :btree
  end
